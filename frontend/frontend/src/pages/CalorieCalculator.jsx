  ...
  return (
    <div className="min-h-screen bg-[#fafafa] dark:bg-slate-950 py-12 px-6">
      <div className="max-w-4xl mx-auto">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-slate-400 hover:text-orange-500 transition-colors mb-8 group text-sm font-medium"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-5 space-y-6 bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-3 rounded-2xl text-sm outline-none focus:ring-2 focus:ring-orange-500 dark:text-white"
                >
            ...
            <button
              ...
              className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 rounded-2xl transition-all shadow-lg shadow-orange-500/20 active:scale-95"
            >
                ...
                >
                  <div className="grid grid-cols-3 gap-4">
                    {result.goals.map((goal, i) => (
                      <div
                        key={i}
                        className={`${goal.bg} p-4 rounded-3xl border border-white dark:border-slate-800 text-center`}
                      >
                        <p className="text-[10px] font-bold text-slate-500 uppercase mb-1">
                          {goal.label}
                        </p>
                        <p className={`text-xl font-black ${goal.color}`}>
                          {goal.value}
                        </p>
                  ...
                  <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50">
                    <div className="flex items-center justify-between mb-8">
                      <h3 className="text-lg font-bold dark:text-white flex items-center gap-2">
                        <Target className="w-5 h-5 text-orange-500" /> Target
                        Macros
                      </h3>
                  ...
                  <div className="p-5 rounded-3xl bg-blue-50/50 dark:bg-slate-900/50 border border-blue-100 dark:border-slate-800 flex gap-4">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                      Your <strong>BMR ({result.bmr} kcal)</strong> is the
                      energy used at rest. To lose fat, stick to the Weight Loss
                      goal while maintaining protein intake to preserve muscle.
                    </p>
                  </div>
                </motion.div>
              ) : (
